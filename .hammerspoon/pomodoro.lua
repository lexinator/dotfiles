...
--  work_period_sec  = 5,
--  rest_period_sec  = 5,
-- TODO: every 4 suppose to take a 20 minute break
--  longer_rest_period_intervals = 4,
--  longer_rest_period_sec = 20 * 60
}
...
function pom_reset_work()
  ...
  pom.var.max_time_sec = pom.config.work_period_sec
  pom_update_menu()
  hs.alert.show("reset everything. press '✧-7' to start", 5)
end
